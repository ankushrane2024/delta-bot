...
def inject_html_css():
    with open('templates/dashboard.html', 'r', encoding='utf-8') as f:
        ...
        # ... (rest of the file remains same, I will use AllowMultiple)
        ...
        <div class="psce-card">
            ...
            <div class="psce-block-alert" id="psce-block-alert">
                ...
                <div>
                    ...
                    <div id="psce-block-reason" style="font-size: 12px; margin-top: 4px;">Reason: </div>
                </div>
            </div>
...
"""
    ...
    if "/* PSCE ARES DECISION CARD CSS */" not in content:
        # Inject CSS right before </style> at line ~347
        content = re.sub(r'(\s*)</style>', r'\n' + css + r'\1</style>', content, count=1)
        
        # Inject HTML right after <!-- TAB 1: LIVE TRADE --> <div class="tab-pane active" id="tab-live">
        target_html = r'(<div class="tab-pane active" id="tab-live">\s*<div class="container">)'
        content = re.sub(target_html, r'\1\n' + html, content)
        ...
        with open('index.html', 'w', encoding='utf-8') as f:
            f.write(content)
        print("PSCE successfully injected into index.html!")
    else:
        print("PSCE already injected.")
